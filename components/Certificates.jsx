  ...
  return (
    <section id="certificates" className="py-24">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <h2 className="mb-9 font-display text-3xl font-bold tracking-tight text-fog md:text-4xl">
          Training and proof.
        </h2>
          ...
          {certificates.map((c, i) => (
            ...
            >
              <div className="relative flex aspect-[4/3] items-center justify-center overflow-hidden border-b border-hair bg-panel2">
                ...
                <span className="absolute left-3 top-3 rounded bg-night/70 px-1.5 py-0.5 font-mono text-xs text-mist">
              ...
              <div className="p-5">
                <h3 className="font-display text-base font-semibold leading-tight text-fog">
                  {c.title}
                </h3>
                ...
                {c.credentialId && (
                  <p className="mt-1 font-mono text-[0.65rem] text-mist/80">
                    ID {c.credentialId}
                  </p>
                )}
              </div>
